...
def LM_Model(x, vsini, rv, temperature, metal, scale, model_getter=None, **mgargs):
    ...
    print vsini, rv, temperature, metal, scale
...
def Fit(arguments, mg=None):
    ...
    fitter.set_param_hint("rv", value=0.0, min=-500, max=500, vary=True)
    ...
    if 1:
        ...
        filename = "GeneratedObservations/HIP_78106_unscaled_t4300_m0.0_rv0_vsini10.0"
        ...
        return result
        result = fitter.MCMC_fit(orders, result, fitcont=False)
        return result
