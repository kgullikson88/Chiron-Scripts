...
if __name__ == "__main__":
    ...
    for fname in fileList:
        good = HelperFunctions.ReadFits(fname, extensions=True, x="wavelength", y="flux", cont="continuum",
                                        errors="error")
        ...
        if fname2 not in allfiles:
            ...
            continue
        bad = HelperFunctions.ReadFits(fname2, extensions=True, x="wavelength", y="flux", cont="continuum",
                                       errors="error")
        modelorders = HelperFunctions.ReadFits(fname2, extensions=True, x="wavelength", y="model", cont="continuum",
                                               errors="error")
